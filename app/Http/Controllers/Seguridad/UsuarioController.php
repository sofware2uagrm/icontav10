...
class UsuarioController extends Controller
{
    ...
    public function pageedit($idusuario) {
        return view( 'seguridad.usuario.edit', compact('idusuario') );
    }
    public function pageshow($idusuario) {
        return view( 'seguridad.usuario.show', compact('idusuario') );
    }
}
